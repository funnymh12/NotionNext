...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '有趣的牟辉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '卡片写作爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://muhui.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,卡片写作', // 网站关键词 英文逗号隔开
